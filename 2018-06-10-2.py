...
s1 >> zap(P[0,0,0,0,1,2,3,4,5,0,6,7,8,3,2,1].shuffle().palindrome(), dur=1, sus=1, chop=P[2,1,0,2,4,4].shuffle().mirror(), tremolo=0.1, vib=0.1, dist=0.2, oct=(4, 5), amp=PEuclid(P[2,4,5,3,7].shuffle().mirror()*2, 8))
...
k1 >> play(P["<X >< x* >"].amen(), sample=2, amp=1)
...
b1 >> sawbass(s1.degree, oct=5, sus=0.1, dur=0.25, amp=PEuclid(P[3,4,5,3,3,4].shuffle().mirror(), 8))
